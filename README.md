# **resources_cn** 开发工具IDEA 汉化(中文化)

[![Build Status](https://travis-ci.org/IntelliJ-Localization/resources_cn.png?branch=master)](https://travis-ci.org/IntelliJ-Localization/resources_cn)
